...
import com.bayue.ciic.activity.live.base.BaseActivity;
import com.bayue.ciic.activity.live.fragment.AudienceFragment;
import com.bayue.ciic.activity.live.fragment.CaptureFragment;
import com.bayue.ciic.activity.live.fragment.ChatRoomMessageFragment;
import com.bayue.ciic.activity.live.fragment.ChatRoomMsgListPanel;
import com.bayue.ciic.activity.live.fragment.LiveBottomBar;
import com.bayue.ciic.activity.live.fragment.LiveRoomInfoFragment;
import com.bayue.ciic.liveStreaming.CapturePreviewController;
import com.bayue.ciic.liveStreaming.PublishParam;
import com.bayue.ciic.nim.NimContract;
import com.bayue.ciic.nim.NimController;
import com.bayue.ciic.nim.constant.GiftType;
import com.bayue.ciic.nim.session.extension.GiftAttachment;
import com.bayue.ciic.nim.session.extension.LikeAttachment;
...
import com.bayue.ciic.util.ScreenUtil;
...
public class LiveRoomActivity extends BaseActivity implements NimContract.Ui{
    ...
    public void onEnterChatRoomSuc(final String roomId) {
        ...
        if (chatRoomFragment != null) {
            ...
            Log.e("LiveRoomActivity>>>>","成功登入聊天室！！！！");
        } else {
    ...
    private void initFinishLiveLayout() {
        ...
        btn_finish_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                MainActivity mainActivity= (MainActivity) App.mainActivity;
                mainActivity.loginNim(Preferences.getAccid(), Preferences.getIm_token());
            }
        });
...
//            Log.e("data=====1111===",bundle.getString("data"));
            ...
            file= GerenShezhi.compressImage2(bitmap);
...
//            bitmap=compressImage(bitmap);
            ...
            glideRequest.
                    ...
                    .into(captureFragment.iv_live_cover);
            captureFragment.file=file;
//            b=true;
...
//            Log.e("base64",pic);*/
            ...
            Bitmap bitmap= BitmapFactory.decodeFile(photos.get(0),GerenShezhi.getBitmapOption(2));
